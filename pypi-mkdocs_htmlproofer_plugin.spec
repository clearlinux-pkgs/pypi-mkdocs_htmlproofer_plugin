...
Source0  : https://files.pythonhosted.org/packages/1c/97/ba794c328e6bf13bf8d0293e1b339d94ccaee92b402a2e67c3eb0122bb2e/mkdocs-htmlproofer-plugin-1.3.0.tar.gz
...
%prep
%setup -q -n mkdocs-htmlproofer-plugin-1.3.0
cd %{_builddir}/mkdocs-htmlproofer-plugin-1.3.0
pushd ..
cp -a mkdocs-htmlproofer-plugin-1.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726854484
